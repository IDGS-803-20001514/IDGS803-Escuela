...
def insert_alumno():
    ...
    return render_template('registrarAlum.html', form = alumno_form)
...
def update_alumno():
    ...
    if request.method == 'GET':
        ...
        return render_template('updateAlum.html', form = alumno_form, id = id, nombre = nombre, apellidos = apellidos, grupo = grupo, email = email)
    ...
    return render_template('updateAlum.html', form = alumno_form)
...
def delete_alumno():
    ...
    return redirect(url_for('alumnos.get_alumnos', form = alumno_form))
